# -*- coding: utf-8 -*-
# !/usr/bin/python
# https://github.com/akirasan/move_detector#
# akirasan.net
...
# Iniciamos camara
# cam = cv2.VideoCapture(r"C:\Users\henri\Documents\Batia Zinger\lecture.mp4")
...
#   imagen_zonas_marcadas = marcar_zonas(imagen_delta, original.copy(),arr)
#   i+=1
#   print(i)
#
#
